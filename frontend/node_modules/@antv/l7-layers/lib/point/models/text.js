  ...
  (0, _createClass2.default)(TextModel, [{
    ...
    value: function generateGlyphLayout(iconfont) {
      ...
      this.glyphInfo = data.map(function (feature) {
        ...
        feature.centroid = (0, _geo.calculateCentroid)(feature.coordinates);
        feature.originCentroid = feature.version === 'GAODE2.x' ? (0, _geo.calculateCentroid)(feature.originCoordinates) : feature.originCentroid = feature.centroid;
        _this2.glyphInfoMap[id] = {
          shaping: shaping,
          glyphQuads: glyphQuads,
          centroid: (0, _geo.calculateCentroid)(feature.coordinates)
        };
        return feature;
      });
    }
