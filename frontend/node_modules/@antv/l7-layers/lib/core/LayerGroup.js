...
var _BaseLayer2 = _interopRequireDefault(require("./BaseLayer"));
...
var LayerGroup = function (_BaseLayer) {
  (0, _inherits2.default)(LayerGroup, _BaseLayer);
  ...
  function LayerGroup() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "isLayerGroup", true);
    return _this;
  }
