...
var DataMappingPlugin = (_dec = injectable(), _dec2 = inject(TYPES.IGlobalConfigService), _dec3 = inject(TYPES.IMapService), _dec4 = inject(TYPES.IFontService), _dec(_class = (_class2 = function () {
  ...
  _createClass(DataMappingPlugin, [{
      ...
      layer.hooks.beforeRender.tap('DataMappingPlugin', function () {
        ...
        if (attributesToRemapping.length) {
          if (filter !== null && filter !== void 0 && filter.needRemapping) {
            layer.setEncodedData(_this.mapping(attributes, filterData, undefined, bottomColor, layer));
            filter.needRemapping = false;
          } else {
            layer.setEncodedData(_this.mapping(attributesToRemapping, filterData, layer.getEncodedData(), bottomColor, layer));
          }
    ...
    value: function generateMaping(layer, _ref2) {
      ...
      layer.setEncodedData(this.mapping(attributes, filterData, undefined, bottomColor, layer));
    ...
    key: "mapping",
    value: function mapping(attributes, data, predata, minimumColor, layer) {
      var _this3 = this;

      var _ref3 = layer === null || layer === void 0 ? void 0 : layer.getLayerConfig(),
